<section>
    <form method="post" action="{{ route('api.send1') }}" class="mt-6 space-y-6">
        ...
        <div class="mt-2 mb-2">
            ...
            <x-text-input id="origin_city" name="origin_city" type="text" class="mt-1 block w-full" :value="old('origin_city') ?? isset($job->data['origin_city']) ? $job->data['origin_city'] : ''" autofocus autocomplete="origin_city" />
            <x-input-error class="mt-2" :messages="$errors->get('origin_city')" />
        </div>

        <div class="mt-2 mb-2">
            <x-input-label for="origin_country" :value="__('Origin country')" />
            <x-text-input id="origin_country" name="origin_country" type="text" class="mt-1 block w-full" :value="old('origin_country') ?? isset($job->data['origin_country']) ? $job->data['origin_country'] : ''" autofocus autocomplete="origin_country" />
        ...
        <div class="mt-2 mb-2">
            ...
            <x-text-input id="origin_postal_code" name="origin_postal_code" type="number" class="mt-1 block w-full" :value="old('origin_postal_code') ?? isset($job->data['origin_postal_code']) ? $job->data['origin_postal_code'] : ''" required autofocus autocomplete="origin_postal_code" />
            <x-input-error class="mt-2" :messages="$errors->get('origin_postal_code')" />
        </div>

        <div class="mt-2 mb-2">
            <x-input-label for="origin_state" :value="__('Origin state')" />
            <x-text-input id="origin_state" name="origin_state" type="text" class="mt-1 block w-full" :value="old('origin_state') ?? isset($job->data['origin_state']) ? $job->data['origin_state'] : ''" autofocus autocomplete="origin_state" />
            <x-input-error class="mt-2" :messages="$errors->get('origin_state')" />
        </div>
        <div class="mt-2 mb-2">
            <x-input-label for="destination_city" :value="__('Destination city')" />
            <x-text-input id="destination_city" name="destination_city" type="text" class="mt-1 block w-full" :value="old('destination_city') ?? isset($job->data['destination_city']) ? $job->data['destination_city'] : ''" autofocus autocomplete="destination_city" />
        ...
        <div class="mt-2 mb-2">
            ...
            <x-text-input id="destination_country" name="destination_country" type="text" class="mt-1 block w-full" :value="old('destination_country') ?? isset($job->data['destination_country']) ? $job->data['destination_country'] : ''" autofocus autocomplete="destination_country" />
        ...
        <div class="mt-2 mb-2">
            ...
            <x-text-input id="destination_postal_code" name="destination_postal_code" type="number" class="mt-1 block w-full" :value="old('destination_postal_code') ?? isset($job->data['destination_postal_code']) ? $job->data['destination_postal_code'] : ''" required autofocus autocomplete="destination_postal_code" />
        ...
        <div class="mt-2 mb-2">
            ...
            <x-text-input id="destination_state" name="destination_state" type="text" class="mt-1 block w-full" :value="old('destination_state') ?? isset($job->data['destination_state']) ? $job->data['destination_state'] : ''" autofocus autocomplete="destination_state" />
