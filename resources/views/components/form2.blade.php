<section>
    <form method="post" action="{{ route('api.send2') }}" class="mt-6 space-y-6">
        ...
        <div class="mt-2 mb-2">
            ...
            <x-text-input id="first_name" name="first_name" type="text" class="mt-1 block w-full" :value="old('first_name') ?? isset($job->data) ? $job->data['first_name'] : ''" required autofocus autocomplete="first_name" />
